...
~function ($, window, undefined) {
    ...
    var win = $(window),
        ...
        ie6 = ie && 'undefined' === typeof (document.body.style.maxHeight),
        dialog,
        dialogZindex = 1e4;
    ...
    dialog.fn = dialog.prototype = {
        ...
        createHTML: function() {
            ...
            if (this.title!==false) {
                html = '<div class="target">' +
                    ...
                    '<a href="javascript:void(0);" title="关闭" class="close">&times;</a>' +
                    '</div>';
            }
        ...
        show: function() {
            ...
            if(this._lock){
                this.$lock.show();
                ie&& !$.support.leadingWhitespace &&this.$lock.css({opacity: this.opacity});
            }
